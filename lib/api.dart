...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> _fetchUserInfo() async {
    ...
    try {
      ...
      if (querySnapshot.docs.isNotEmpty) {
        ...
        setState(() {
          privatekey = documentSnapshot['key'];
  ...
  Future<void> listTransactions(String apiKey, String address) async {
    final apiUrl =
        "https://api-sepolia.etherscan.io/api?module=account&action=txlist&address=$address&apikey=$apiKey";
